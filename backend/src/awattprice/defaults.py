...
ENTSOE_FULL_FALLBACK_UPDATE_HOUR = 17
...
GENERATION_INCREMENTAL_HOURS = 48
GENERATION_FULL_REFRESH_INTERVAL_SECONDS = 24 * 60 * 60
REFRESHER_HISTORY_INTERVAL_SECONDS = 24 * 60 * 60
PRICE_ARCHIVE_YEARS = 2
PRICE_ARCHIVE_RETENTION_BUFFER_MONTHS = 1
PRICE_ARCHIVE_RETRY_INTERVAL_SECONDS = 60 * 60
REFRESHER_CONCURRENCY = 3
REFRESHER_GENERATION_CONCURRENCY = 1
PRICE_ARCHIVE_CONCURRENCY = 3
...
PRICE_DATABASE_FILE_NAME = "prices.sqlite"
...
GENERATION_PUBLISHED_HISTORY_RESPONSE_FILE_NAME = "generation-published-history-{}-{}h.json"
GENERATION_RAW_CACHE_FILE_NAME = "generation-raw-{}-{}h.json"
